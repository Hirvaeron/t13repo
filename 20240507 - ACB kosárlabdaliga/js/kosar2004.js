...
var kosarlabdaObjektum = ObjektumFeltolto(eredmenyek);
console.log(kosarlabdaObjektum);
function RealMadridMerkozesSzam(vizsgaltTomb) {
    var hazaiMeccsekSzama = 0;
    var idegenMeccsekSzama = 0;
...
function RealMadridMerkozesSzamKiir(MerkozesekSzama) {
    document.write("3. feladat: Real Madrid: Hazai: ".concat(MerkozesekSzama[0], ", Idegen: ").concat(MerkozesekSzama[1]));
}
RealMadridMerkozesSzamKiir(RealMadridMerkozesSzam(kosarlabdaObjektum));
function DontetlenVizsgalat(vizsgaltTomb) {
    var vizsgalatEredmenye = false;
    for (var i = 0; i < vizsgaltTomb.length; i++) {
...
function DontetlenVizsgalatKiir(vizsgalatEredmeny) {
...
function BarcelonaiCsapatNeve(vizsgaltTomb) {
    var keresettSzoveg = "Barcelona";
    var pontosTalalat = "";
    for (var i = 0; i < vizsgaltTomb.length; i++) {
        var aktualisHazaiCsapat = vizsgaltTomb[i].hazaiCsapatNeve;
...
function BarcelonaiCsapatNeveKiir(csapatNeve) {
    document.write("<br>5. feladat: barcelonai csapat neve: ".concat(csapatNeve));
}
BarcelonaiCsapatNeveKiir(BarcelonaiCsapatNeve(kosarlabdaObjektum));
function MeccsAdatFeltolto(vizsgaltTomb) {
    var beolvasottAdatok = [];
    for (var i = 0; i < vizsgaltTomb.length; i++) {
...
function MeccsAdatKiir(vizsgaltTomb) {
    document.write("<br>6. feladat:");
    for (var i = 0; i < vizsgaltTomb.length; i++) {
        var aktualisAdat = vizsgaltTomb[i];
        document.write("<br>".concat(aktualisAdat.hazaiCsapatNeve, "-").concat(aktualisAdat.idegenCsapatNeve, " (").concat(aktualisAdat.hazaiCsapatPont, ":").concat(aktualisAdat.idegenCsapatPont, ")"));
    }
}
MeccsAdatKiir(MeccsAdatFeltolto(kosarlabdaObjektum));
function StadionokListaja(vizsgaltTomb) {
    var stadionokListaja = [];
    for (var i = 0; i < vizsgaltTomb.length; i++) {
        var szerepelE = false;
        for (var j = 0; j < stadionokListaja.length; j++) {
...
function StadionSzamlalo(vizsgaltTomb, keresettStadion) {
    var db = 0;
    for (var i = 0; i < vizsgaltTomb.length; i++) {
...
function StadionAdatFeltolto(stadionLista) {
    var beolvasottAdatok = [];
    for (var i = 0; i < stadionLista.length; i++) {
        var stadionAdatok = {
...
var stadionokMerkozesSzamai = StadionAdatFeltolto(StadionokListaja(kosarlabdaObjektum));
function StadionAdatKiir(vizsgaltTomb) {
    document.write("<br>7. feladat:");
    for (var i = 0; i < vizsgaltTomb.length; i++) {
        if (vizsgaltTomb[i].merkozesekSzama > 20) {
            document.write("<br>".concat(vizsgaltTomb[i].stadionNeve, ": ").concat(vizsgaltTomb[i].merkozesekSzama));
        }
    }
}
